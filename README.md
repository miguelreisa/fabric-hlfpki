...
2. To build for example peer image: 
3. cd build build/image/peer
4. docker build -t hlf-pki-base-peer . #change hlf-pki-base-peer and the repository for the name you desire
5. docker tag hlf-pki-base-peer:latest migpe/hlf-pki-base-peer:latest
6. docker push migpe/hlf-pki-base-peer:latest
